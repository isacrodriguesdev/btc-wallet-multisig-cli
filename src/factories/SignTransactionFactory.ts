...
import { SignTransactionUseCase } from "../useCases/SignTransaction/SignTransactionUseCase"
...
export function SignTransactionFactory() {
  ...
  return new SignTransactionUseCase(axiosControllerAdapter, bcoinControllerAdapter)
}